...
for lib in ['psutil', 'tkinter', 'requests']:
    autoload(lib)

# 🧠 Imports
import psutil, threading, hashlib, time, requests
    ...
    def run(self):
        ...
        while self.running:
            ...
            if sent > 0 or recv > 0:
                ...
                # Get destination IP and country
                ...
                if connections:
                    ...
                    self.gui_ref.show_destination_info("None", "N/A")
...
class MagicBoxGUI:
    def __init__(self, root):
        ...
        self.flagged_data = tk.Label(root, text="None", bg="#1e1e2f", fg="#ff9800", font=("Arial", 10), wraplength=440, justify="left")
        ...
        self.footer = tk.Label(root, text="MagicBox v2.2 • Swarm-Aware • Self-Rewriting • Silent Mode", bg="#1e1e2f", fg="#888", font=("Arial", 10))
