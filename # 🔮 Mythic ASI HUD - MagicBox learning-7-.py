# 🧠 Mythic ASI HUD with Drag-and-Drop Ingestion
...
# 🔁 ASI Logic Core with Fusion Weights
class ASILogicCore:
...
def launch_constellation_gui():
    ...
    drop_label = tk.Label(drop_frame, text="📥 Drop Any File Here", fg="#00F7FF", bg="#1A1A2E", font=("Consolas", 12))
    drop_label.place(relx=0.5, rely=0.5, anchor="center")

    def parse_file_and_evolve(file_path):
        try:
    ...
    def on_file_drop(event):
        ...
        parse_file_and_evolve(file_path)
