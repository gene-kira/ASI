...
from process_overlay import animate_process_overlay, handle_process_click
...
class MagicBoxSentinel(tk.Tk):
    ...
    def on_canvas_click(self, event):
        handle_process_click(event, self.canvas, self.zoom_scale, *self.canvas_origin, self)
    ...
    def animate_glyphs(self):
        ...
        animate_glyphs(self.canvas, self.glyphs, self.zoom_scale, ox, oy)
        render_thinking_overlay(self.canvas, self.zoom_scale, ox, oy)
        animate_process_overlay(self.canvas, self.zoom_scale, ox, oy)
