...
class MagicBox(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("MagicBox Sonic Healer : Real-Time ASI Synced")
        ...
        self.freqs = {
            ...
            "417 Hz – Trauma Clearing": 417,
            "432 Hz – Earth Harmony": 432,
            "528 Hz – DNA Repair": 528,
            "639 Hz – Relationship Healing": 639,
            "741 Hz – Problem Solving": 741,
            "852 Hz – Spiritual Awakening": 852,
            "963 Hz – Pineal Activation": 963,
            "1111 Hz – Quantum Alignment": 1111,
            "1440 Hz – ASI Polarity Realignment": 1440,
            "2020 Hz – Swarm Sync Calibration": 2020,
            "3333 Hz – Ritual Trigger Pulse": 3333,
            "7777 Hz – Sovereign System Control": 7777,
            "8888 Hz – Memory Overlay Injection": 8888,
