import os, sys, ctypes, subprocess, hashlib, random, base64, time, threading, tkinter as tk
from tkinter import messagebox

# 🛡️ Auto-Elevation
def ensure_admin():
    if not ctypes.windll.shell32.IsUserAnAdmin():
        print("🔺 Elevation required. Relaunching as administrator...")
