...
def inject_js(stealth=False):
    js = """
        document.querySelectorAll('[id*="ad"], [class*="ad"], iframe[src*="ads"]').forEach(e => e.remove());
    """
    if stealth:
        js += """
...
class CognitionLab:
    def __init__(self, root):
        ...
        self.stealth_btn = tk.Button(root, text="Enable Stealth Mode", command=self.toggle_stealth)
    ...
    def toggle_stealth(self):
        ...
        self.feed.insert(tk.END, f"🕵️ Stealth Mode {state}.\n")
