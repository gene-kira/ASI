...
class IPAuditPanel(tk.Frame):
    def __init__(self, parent):
        ...
        title = tk.Label(self, text="📜 Blocked IP Audit", fg="#0ff", bg="#111", font=("Helvetica", 12, "bold"))
        title.pack(pady=5)
    ...
    def log_block(self, ip, country):
        entry = tk.Label(self.log_frame, text=f"🚫 {ip} → {country}", fg="#0f0", bg="#111", anchor="w", font=("Courier", 10))
