import os, sys, threading, time, uuid, socket
try:
    import psutil
except ImportError:
...
class MythicFace:
    def __init__(self, brain):
        ...
        self.canvas = Canvas(self.root, width=800, height=400, bg=theme["bg"], highlightthickness=0)
        self.canvas.pack()
    ...
    def animate_particles(self):
        theme = CONFIG["colors"][CONFIG["theme"]]
        for _ in range(30):
            x, y = uuid.uuid4().int % 800, uuid.uuid4().int % 400
