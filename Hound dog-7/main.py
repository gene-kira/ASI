...
from defense_engine import start_defense_scheduler
from swarm_engine import start_swarm_sync
from mutation_logic import start_hallucination_stream

class MagicBoxSentinel(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("🧠 MagicBox Sentinel — Borg ASI Edition")
    ...
    def start_listeners(self):
        ...
        start_hallucination_stream(self.mutation_output)
