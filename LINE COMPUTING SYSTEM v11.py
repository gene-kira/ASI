...
# + heavy predictive engine + HYBRID ALLOW-FOLDING
# + seeded baseline + auto-start + auto-profiling
# ============================================================
...
def load_settings():
    ...
    # Seeded baseline for a typical Windows 10/11 environment.
    return {
        ...
        # Common system/user processes you likely expect.
        "process_whitelist": [
            "explorer.exe",
            "SearchApp.exe",
        ...
        # Example bad actors / placeholders – extend with real intel.
        "process_blacklist": [
            "mimikatz.exe",
            "mimikat.exe",
            "lsassdump.exe",
        ...
        # Per-process policy examples for a Windows dev box.
        # Actions: "allow" | "log" | "alert" | "kill" | "ignore"
        "process_policies": {
            "POWERSHELL.EXE": "alert",       # powerful, scriptable
            "PWSH.EXE": "alert",
            "CMD.EXE": "log",
            "PYTHON.EXE": "log",
            "NODE.EXE": "log",
        ...
        "folding": {
            "unknown_threshold": 5  # cautious: need 5 occurrences before folding unknown into line
        },

        # New: auto-behavior flags
...
class LineGUI:
    ...
    # Control buttons (still available, even in auto mode)
